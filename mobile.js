...
/*
    create a sidebar button specifically for mobile users
*/
...
topbar.insertBefore(sidebarButton, home);//insert the sidebar button at the start of the topbar

/*
    function to open/close the sidebar when the sidebar button 
    has been pressed
*/
